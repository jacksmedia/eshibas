...
const Roadmap = () => (
  <Layout>
    ...
    <div className="container pt-3 pl-3 is-fluid spacer-zone">
      <h1>Elrond Shiba CDO/DAO Roadmap</h1>
      <h2>Plans Q2</h2>
      <ul>
        <li>WAFL tokens used in collabs/fusions with other NFT collections</li>
        <li>Upcoming Elrond Shiba Merch Store, funded by royalties</li>
        <li>Mint ANISHIB NFT collection</li>
      </ul> 
      <h2>Plans Q3+</h2>
      <ul>
        <li>Gateway to ShibaWorld metaverse opens</li>
        <li>Mint 3DSHIB NFT collection</li>
        <li>$WAFL registered as Tradeable Asset (SEC, other regulations)</li>
      </ul>
    </div>
